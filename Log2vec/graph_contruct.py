...
nx.write_edgelist(graph, "./our_data/graph_edge_list2")
nx.write_gpickle(graph, "./our_data/graph.gpickle2")
# nx.draw(graph, with_labels=False, edge_color='b', node_color='g', node_size=5)
# plt.show()
